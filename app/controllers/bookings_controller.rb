...
require 'json'
    ...
    def create
        ...
        json = {
            ...
            "provider_id": materiales_seleccionados[0]["provider_id"],
            "start_date": Date.today + materiales_seleccionados[0]["delivery_time"] ,
            "end_date": Date.today + materiales_seleccionados[0]["delivery_time"] ,
            "quantity":@materials[0]["total_quantity"],
            "material": materiales_seleccionados[0]["material"]["name"],
            "delivery_place":  ""
        }.to_json  
        ...
        arrayFechas = [Date.today + materiales_seleccionados[0]["delivery_time"]].to_json
        BonitaApi.set_variable("fechasTimer", "#{arrayFechas}", "java.lang.String", @collection.id_i_bonita)
        ...
        redirect_to root_path , alert: "Debes elegir un lugar de fabricación para completar la reserva"
            ...
            puts "redefinir parametros consulta"
        end 
    end 
    ...
    def create_bookings_makers
        ...
        reservarMaterialesValue["delivery_place"] = maker["address"]
        BonitaApi.set_variable("reservarMateriales", "#{reservarMaterialesValue}", "java.lang.String", @collection.id_i_bonita)
